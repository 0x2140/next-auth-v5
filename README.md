# Skeletton with Next Auth v5 based on Tutorial called Next Auth v5 - Advanced Guide (2024) from Antonio Erdeljac
...
The tutrial is based on postgresql Database.
This repos is based on sqlite Database.
Difference is mainly on Enum type available on postgresql, not on sqlite.

Workaround: using String type and handling différently on code.
